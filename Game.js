...
if (pokracovatvehre!==false){
    ...
    else { document.getElementById("celkoveskore1").innerHTML = "Player 1 win!!!";
        document.getElementById("aktualniskore1").innerHTML = "Player 1 win!!!";
    ...
    if (celkoveskore2<100){
        ...
        dalsihrac();
        zmenastylu(); }
        else {  document.getElementById("celkoveskore2").innerHTML = "Player 2 win!!!";
        document.getElementById("aktualniskore2").innerHTML = "Player 2 win!!!";
...
if (aktivnihrac===1){
    ...
    if (celkoveskore2<100){
        ...
        aktivnihrac=2;} else {document.getElementById("celkoveskore2").innerHTML = "Player 1 win!!!";
        document.getElementById("aktualniskore2").innerHTML = "Player 1 win!!!";
        document.getElementById("jmeno2").innerHTML = "";
        document.getElementById("jmenoakt2").innerHTML = "";
        stophry();
                            }
        ...
        aktivnihrac=1;} else {document.getElementById("celkoveskore1").innerHTML = "Player 1 win!!!";
        document.getElementById("aktualniskore1").innerHTML = "Player 1 win!!!";
        document.getElementById("jmeno1").innerHTML = "";
        document.getElementById("jmenoakt1").innerHTML = "";
        stophry();
...
document.getElementById("jmeno1").innerHTML = "Total score of player 1";
    
document.getElementById("jmenoakt1").innerHTML = "Current score of player 1";

document.getElementById("jmeno2").innerHTML = "Total score of player 2";
    
document.getElementById("jmenoakt2").innerHTML = "Current score of player 2";      
